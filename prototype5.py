...
IMGBB_API_KEY = "427b00cf9129e9a12cc0e4a5005e4e26"  # ใส่ API Key ของคุณที่นี่ เช่น "abc123xyz456"
                ...
                if inside_zone and conf > 0.5:
                    ...
                    if current_time - last_notify_time > notify_cooldown:
                        ...
                        text_msg = (
                            ...
                            f"โปรดตรวจสอบผู้สูงอายุในรูปภาพ\n"
                            f"📍 ตำแหน่ง: กล้องตัวที่ 1\n"
                            f"⏰ เวลา: {timestamp}\n"
                            f"📊 มั่นใจว่าเป็นมนุษย์: {conf:.2%}\n"
                            f"━━━━━━━━━━━━━━━\n"
                            f"📸 รูปภาพของบุคคลที่เช้าเขตโซนตรวจจับ"
                        )
